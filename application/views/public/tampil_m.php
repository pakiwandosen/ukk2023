...
-->
    ...
    <link rel="stylesheet" href="<?= base_url(); ?>templates/css/font-awesome.min.css">
    ...
    <!-- MAIN CSS -->
    <link rel="stylesheet" href="<?= base_url(); ?>templates/css/templatemo-digital-trend.css">
...
<body>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12">
                    <div class="hero-image" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <img src="<?= base_url(); ?>templates/images/working-girl.png" class="img-fluid" alt="working girl">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-7 mx-auto col-md-10 col-12">
                    ...
                    <div class="about-image" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <img src="<?= base_url(); ?>templates/images/office.png" class="img-fluid" alt="office">
                    </div>
                </div>
    ...
    <script src="<?= base_url(); ?>templates/js/aos.js"></script>
    <script src="<?= base_url(); ?>templates/js/owl.carousel.min.js"></script>
    <script src="<?= base_url(); ?>templates/js/smoothscroll.js"></script>
